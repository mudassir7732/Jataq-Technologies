...
const Testimonials = () => {
    return (
        <div className="h-[750px] lg:h-[640px] "
            ...
            <div className="flex flex-col lg:flex-row items-center mt-20 lg:items-center gap-x-[35px] lg:justify-between border-white h-ful px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] xl:px-[115px]">

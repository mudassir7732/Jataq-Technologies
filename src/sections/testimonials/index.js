...
const Testimonials = () => {
    return (
        <div className="relative min-h-[750px] lg:h-fit"
            style={{
        ...
        >
            ...
            <div className="flex flex-col lg:flex-row items-center mt-48 lg:items-center z-50 gap-x-[35px] lg:justify-between border-white h-ful px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] xl:px-[115px]">
                ...
                <div className="flex flex-col min-w-[45%] mt-14 lg:mt-0">
                    <img src='/assets/icons/quotation.svg' alt='button_background' className=" absolute -mt-[58px] ml-3 z-50" />
                    <div className=" bg-white z-40 rounded-t-[10px] max-w-[600px] pt-[35px] sm:pt-[42px] md:pt-[45px] lg:pt[60px] xl:pt-[80px] px-[15px] sm:px-[22px] md:px-[28px] lg:px-[35px] xl:px-[45px]">

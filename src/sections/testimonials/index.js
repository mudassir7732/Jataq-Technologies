...
const Testimonials = () => {
    return (
        <div className="relative pb-20 lg:h-fit"
            ...
            <div className="flex flex-col lg:flex-row items-center mt-48 lg:items-center gap-x-[35px] lg:justify-evenly border-white h-ful px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] xl:px-[115px]">
                ...
                <div className="flex flex-col min-w-[45%] mt-14 lg:mt-0">
                    <img src='/assets/icons/quotation.svg' alt='button_background' className=" absolute -mt-[58px] ml-3" />

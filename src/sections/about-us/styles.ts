const styles={
    ...
    second_section:"flex flex-col w-full lg:w-[45%] max-w-[640px] pt-8",
    ...
    first_button:"bg-[#006fff] outline-none text-white rounded-[10px] w-[190px] sm:w-[220px] lg:min-w-[240px] xl:min-w-[268px] h-[40px] sm:h-[45px] lg:h-[53px] text-[17px] lg:text-[18px] font-[400] lg:font-[500]",

...
const Services = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row items-start justify-evenly lg:justify-between py-[30px] sm:py-[70px] md:py-[95px] px-[40px] sm:px-[70px] md:px-[82px] lg:px-[95px] xl:px-[115px] h-[980px] lg:h-[663px] w-full" style={{ backgroundImage: 'url(/assets/images/bg.svg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>

const styles = {
    container: "flex flex-col lg:flex-row bg-no-repeat bg-cover bg-center items-start justify-between py-[30px] sm:py-[70px] md:py-[95px] bg-[#0a0b0f] px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] xl:px-[115px] w-full",
    first_section: "flex flex-col items-start w-fit w-full xl:max-w-[47%]",
    ...
    second_section: "flex flex-col mt-4 lg:mt-0 w-full max-w-[450px]",
    ...
    text_wrapper: "flex flex-row items-center mx-[20px] md:mx-[41px] lg:mx-[25px] xl:mx-[41px] justify-between h-[88px] min-w-[70%] sm:min-w-[85%] md:max-w-[200px] lg:w-fit border-b-[1px] border-[#4e4e4e] pb-[15px]",
    service_text: "text-white text-[16px] md:text-[17px] lg:text-[16px] xl:text-[18px] font-[400] font-[Montserrat]",

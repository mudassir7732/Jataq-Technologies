const styles = {
    container: "background-container flex flex-col lg:flex-row bg-no-repeat bg-cover bg-center items-start justify-between xl:justify-evenly py-[30px] sm:py-[70px] md:py-[95px] px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] bg-[#0a0b0f] xl:px-[115px] w-full",

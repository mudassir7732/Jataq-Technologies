        ...
        <div className="flex flex-col w-full">
            ...
            <div className="w-full mt-[107px] px-[30px] sm:px-[60px] md:px-[82px] lg:px-[95px] xl:px-[115px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-[38px] sm:mt-[45px] md:mt-[60px]">
                    <div className="border-[#d2d2d2] pr-[24px] pb-[15px] sm:pb-[29px] sm:border-b-[1px] sm:border-r-[1px]">
                        <p className="text-[25px] sm:text-[30px] md:text-[35px] lg:text-[38px] font-[700] text-[#006fff]">
                            01
                        </p>
                    ...
                    <div className="border-[#d2d2d2] sm:pl-[24px] lg:px-[24px] pb-[15px] sm:pb-[29px] sm:border-b-[1px] lg:border-r-[1px]">
                    ...
                    <div className="border-[#d2d2d2] sm:pr-[24px] lg:pl-[24px] pb-[15px] sm:pb-[29px] sm:border-b-[1px] sm:border-r-[1px] lg:border-r-0">
                        <p className="text-[25px] sm:text-[30px] md:text-[35px] lg:text-[38px] font-[700] text-[#d2d2d2]">
                            03
                        </p>
                        <p className="text-[19px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-[700] text-[#252525] mt-[7px]">
                    ...
                    <div className="border-[#d2d2d2] sm:pl-[24px] lg:pr-[24px] lg:pl-0 lg:border-r-[1px] sm:border-b-[1px] lg:border-b-0 pb-[15px] sm:pb-[29px]">
                        <p className="text-[25px] sm:text-[30px] md:text-[35px] lg:text-[38px] font-[700] text-[#d2d2d2]">
                            04
                        </p>
                        <p className="text-[19px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-[700] text-[#252525] mt-[7px]">
                    ...
                    <div className="border-[#d2d2d2] pr-[24px] lg:px-[24px] sm:border-r-[1px] pb-[15px] sm:pb-[29px]">
                        <p className="text-[25px] sm:text-[30px] md:text-[35px] lg:text-[38px] font-[700] text-[#d2d2d2]">
                            05
                        </p>
                        <p className="text-[19px] sm:text-[20px] md:text-[22px] lg:text-[24px] font-[700] text-[#252525] mt-[7px]">
